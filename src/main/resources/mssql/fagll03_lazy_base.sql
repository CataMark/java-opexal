select
    ...
    q.*,
    p.segment,
    r.nume as kostl_nume,
    s.nume as aufnr_nume,
    t.nume as projk_nume,
    u.nume as vbund_nume,
    v.nume as glvor_nume,
    w.nume as blart_nume,
    x.nume as konto_nume,
    y.nume as u_matnr_nume,
    z.nume as u_lifnr_nume
