create or alter procedure oxal1.prc_co_order_insert_return
    @cod char(9),
    @coarea char(4),
    @cocode char(4),
    @nume nvarchar(100),
...
as
    begin
        ...
        insert into oxal1.tbl_int_co_order (cod, coarea, cocode, nume, profit_center, cost_center_resp, mod_de, mod_timp)
