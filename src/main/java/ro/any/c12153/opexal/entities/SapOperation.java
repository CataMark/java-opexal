 ...
 * @author C12153
 */
public class SapOperation implements Serializable{
    ...
    public SapOperation(Map<String, Object> inreg){
    ...
    public SapOperation(String json){
    ...
    public SapOperation(JsonObject json){
        try {
            this.parseJson(json);
        } catch (Exception ex) {
            throw new RuntimeException(ex.getMessage(), ex.getCause());
