 ...
 * @author C12153
 */
public class SapTransaction implements Serializable {
    ...
    public SapTransaction(Map<String, Object> inreg){
    ...
    public SapTransaction(String json){
    ...
    public SapTransaction(JsonObject json){
        try {
            this.parseJson(json);
        } catch (Exception ex) {
            throw new RuntimeException(ex.getMessage(), ex.getCause());
