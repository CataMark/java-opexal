 ...
 * @author C12153
 */
public class OpexCategory implements Serializable{
    private static final long serialVersionUID = 1L;
    
    //database table field name
    private static final String COD = "cod";
    private static final String NUME = "nume";
    private static final String CDRIVER = "cost_driver";
    private static final String CONT = "cont_ccoa";
    ...
    public OpexCategory(JsonObject json){
        try {
            this.parseJson(json);
        } catch (Exception ex) {
            throw new RuntimeException(ex.getMessage(), ex.getCause());
    ...
    private void parseJson(JsonObject jsonO) throws Exception{
        ...
        if (jsonO.containsKey(CDRIVER) && !jsonO.isNull(CDRIVER)) this.cdriver = jsonO.getString(CDRIVER);
    ...
    public JsonObject getJson(){
        ...
        if (this.cdriver != null) jsonb.add(CDRIVER, this.cdriver);
