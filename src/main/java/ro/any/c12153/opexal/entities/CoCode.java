...
public class CoCode implements Serializable {
    ...
    private void parseJson(JsonObject jsonO) throws Exception{
        ...
        if (jsonO.containsKey(COAREA) && !jsonO.isNull(COAREA)) this.coarea = new CoArea(jsonO.getJsonObject(COAREA));
    ...
    public JsonObject getJson(){
        ...
        if (this.coarea != null) jsonb.add(COAREA, this.coarea.getJson());
