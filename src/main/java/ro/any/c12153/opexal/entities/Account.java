...
public class Account implements Serializable{    
    ...
    private static final String ALTERNATIV = "alternativ";
    ...
    public Account(Map<String, Object> inreg){
        this.cod = (String) inreg.get(COD);
        this.alternativ = (String) inreg.get(ALTERNATIV);
    ...
    private void parseJson(JsonObject jsonO) throws Exception{
        ...
        if (jsonO.containsKey(ALTERNATIV) && !jsonO.isNull(ALTERNATIV)) this.alternativ = jsonO.getString(ALTERNATIV);
    ...
    public JsonObject getJson(){
        ...
        if (this.alternativ != null) jsonb.add(ALTERNATIV, this.alternativ);
