...
public class Wbs implements Serializable{
    ...
    private static final String DEFINITIE = "definitie";
    ...
    public Wbs(Map<String, Object> inreg) {
    ...
    private void parseJson(JsonObject jsonO) throws Exception{
        ...
        if (jsonO.containsKey(DEFINITIE) && !jsonO.isNull(DEFINITIE)) this.definitie = jsonO.getString(DEFINITIE);
