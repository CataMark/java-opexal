 ...
 * @author C12153
 */
public class SapDocType implements Serializable{
    ...
    public SapDocType(Map<String, Object> inreg){
    ...
    public SapDocType(JsonObject json){
        try {
            this.parseJson(json);
        } catch (Exception ex) {
            throw new RuntimeException(ex.getMessage(), ex.getCause());
