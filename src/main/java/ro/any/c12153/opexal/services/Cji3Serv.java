...
public class Cji3Serv {
    ...
    public static LazyDataModelRecords<Map<String, Object>> getLazyRecords(Short an, Short luna, String coarea, int after, int size,
        ...
        //pregatire baza sql
        String sqlBase = String.format(App.getSql("cji3_lazy_base"),
        ...
        //obtine suma
        String sqlSum = String.format(App.getSql("recs_lazy_get_sum"), "wrvbtr", sqlBase);
    ...
    public static String deleteByFilter(Short an, Short luna, String coarea, Optional<Map<String, String>> filter, String userId) throws Exception{
        String sql = String.format(App.getSql("cji3_lazy_delete_by_filter"), (filter.isPresent() ? getFilterSql(filter.get()) : ""));
    ...
    public static String deleteById(List<String> ids, String userId) throws Exception{
        String sql = App.getSql("cji3_lazy_delete_by_id");
    ...
    public static String updateByFilter(Short an, Short luna, String coarea, Optional<Map<String, String>> filter, Cji3DocUpdate updateValues, String userId) throws Exception{
        ...
        String sql = String.format(App.getSql("cji3_lazy_update_by_filter"), sqlUpdate, (filter.isPresent() ? getFilterSql(filter.get()) : ""));
        return App.getConn(userId).executePreparedStatement(sql, Optional.of(parametri));
    }
    
    public static String updateById(List<String> ids, Cji3DocUpdate updateValues, String userId) throws Exception{
        String sqlUpdate = updateValues.sqlUpdate();
        List<ParamSql> paramsUpdateValues = updateValues.sqlParametri();
        ...
        String sql = String.format(App.getSql("cji3_lazy_update_by_id"), sqlUpdate);
        return App.getConn(userId).executePreparedStatement(sql, parametri);
    }
    ...
    public static void toXlsx(Short an, Short luna, String coarea, Optional<Map<String, String>> filter, String userId, OutputStream out) throws Exception{
        String sql = String.format(App.getSql("cji3_lazy_get_all_by_filter"), (filter.isPresent() ? getFilterSql(filter.get()) : ""));
    ...
    public static void collectMasterData(UUID load_uuid, String coarea, Optional<Date> startTime, String userId) throws Exception{        
        ...
        App.getConn(userId).executeCallableStatement("{call oxal1.prc_cji3_collect_master_data(?,?,?,?)}", parametri);
    }
}
